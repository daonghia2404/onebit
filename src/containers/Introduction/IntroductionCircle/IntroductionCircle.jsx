...
const IntroductionCircle = () => {
  ...
  const widthSize = renderCircleSize();
  const heightSize = renderCircleSize();
  ...
  const init = () => {
    ...
    camera = new THREE.PerspectiveCamera(50, widthSize / heightSize, 1, 1000);
    ...
    var geom = new THREE.IcosahedronGeometry(3, 7);
  ...
  return <div className="IntroductionCircle flex justify-center" id="canvas"></div>;
};
